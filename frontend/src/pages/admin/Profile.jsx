...
import { User, Mail, Phone, Lock, Save, CheckCircle, Camera, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-10">
        ...
        <p className="text-gray-500 mt-2 font-medium">Manage your administrator settings and profile information.</p>
      </div>
      ...
      <div className="bg-white rounded-[2.5rem] shadow-2xl shadow-blue-100/50 overflow-hidden border border-gray-100">
        <div className="lg:flex">
          ...
          <div className="lg:w-1/3 bg-blue-600 p-10 text-white flex flex-col justify-between relative overflow-hidden">
            <div className="relative z-10 flex flex-col items-center">
              ...
              <div className="text-center">
                ...
                <p className="text-blue-100 text-xs font-black uppercase tracking-[0.2em] opacity-80">System Administrator</p>
              </div>
            </div>
            
            <div className="relative z-10 mt-10 p-6 bg-white/10 rounded-3xl border border-white/10 backdrop-blur-sm">
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-200 mb-3 opacity-60">Account Status</p>
              <div className="flex items-center text-xs font-black text-white uppercase tracking-widest">
                <div className="h-2 w-2 bg-green-400 rounded-full mr-3 shadow-[0_0_8px_rgba(74,222,128,0.6)] animate-pulse"></div>
                Super Admin Access
              </div>
            </div>
          ...
          <div className="lg:w-2/3 p-10 lg:p-14">
            {success && (
              <div className="mb-8 bg-green-50 border-l-4 border-green-500 p-4 rounded-r-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Admin Name</label>
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 text-white py-4 rounded-2xl font-black uppercase tracking-widest shadow-xl shadow-blue-200 hover:bg-blue-700 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center space-x-3"
              >
                <Save size={20} />
